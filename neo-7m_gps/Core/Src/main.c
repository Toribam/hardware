...
int main(void)
{
  ...
  // Function to parse GPRMC data for latitude, longitude, and time
  ...
  // Function to parse GPGGA data for number of satellites
  ...
  // Function to format time from hhmmss.ss to hh:mm:ss
